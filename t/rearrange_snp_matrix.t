...
system("$rearrange_bin -k -r VC-18 -s increasing -t $script_dir/tree/input/pseudoalign.phy_phyml_tree.txt -o ".$create_dir."/ -m $script_dir/tree/input/matrix.csv -p $script_dir/tree/input/pseudoalign.phy");
...
$create_dir = tempdir(TEMPLATE => 'XXXXX', CLEANUP => 1) or die "Unable to create temporary file directory.";
system("$rearrange_bin -c -t $script_dir/tree/input/pseudoalign.phy_phyml_tree.txt -o ".$create_dir."/ -m $script_dir/tree/input/matrix.csv -p $script_dir/tree/input/pseudoalign.phy");
...
$create_dir = tempdir(TEMPLATE => 'XXXXX', CLEANUP => 1) or die "Unable to create temporary file directory.";
system("$rearrange_bin -s decreasing -t $script_dir/tree/input/pseudoalign.phy_phyml_tree.txt -o ".$create_dir."/ -m $script_dir/tree/input/matrix.csv -p $script_dir/tree/input/pseudoalign.phy");
