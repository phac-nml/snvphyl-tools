...
system("$mapping_bin -l ".$create_dir."/ --bam bam1=$mapping_dir/input/sample1.bam --bam bam2=$mapping_dir/input/sample2.bam --bam bam3=$mapping_dir/input/sample3.bam --bam bam4=$mapping_dir/input/sample4.bam 2>&1");
...
system("$mapping_bin -l ".$create_dir."/ --bam bam1=$mapping_dir/input/sample1.bam --bam bam2=$mapping_dir/input/sample2.bam --bam bam3=$mapping_dir/input/sample3.bam --bam bam4=$mapping_dir/input/sample4.bam --min-depth 35 2>&1");
ok(countLines($create_dir."/mapping_percentage.log") == 8, "The correct number of isolates are logged when min_depth altered.");

#4 => verify that the appropriate number of isolates are logged when the minimum mapping percentage is changed
$create_dir = tempdir(TEMPLATE => 'XXXXX', CLEANUP => 1) or die "Unable to create temporary file directory.";
system("$mapping_bin -l ".$create_dir."/ --bam bam1=$mapping_dir/input/sample1.bam --bam bam2=$mapping_dir/input/sample2.bam --bam bam3=$mapping_dir/input/sample3.bam --bam bam4=$mapping_dir/input/sample4.bam -min-map 99.9 2>&1");
ok(countLines($create_dir."/mapping_percentage.log") == 8, "The correct number of isolates are logged when min_mapping altered.");

#5 => verify that script dies with error message when no valid bam files are input
$create_dir = tempdir(TEMPLATE => 'XXXXX', CLEANUP => 1) or die "Unable to create temporary file directory.";
$command = "$mapping_bin -l ".$create_dir."/ --bam nobam=$mapping_dir/no_bams_here 2>&1";
...
$create_dir = tempdir(TEMPLATE => 'XXXXX', CLEANUP => 1) or die "Unable to create temporary file directory.";
$command = "$mapping_bin -l ".$create_dir."/ --bam bam1=$mapping_dir/input/sample1.bam --bam bam2=$mapping_dir/input/sample2.bam --bam bam3=$mapping_dir/input/sample3.bam --bam bam4=$mapping_dir/input/sample4.bam -c 2 2>&1";
...
$create_dir = tempdir(TEMPLATE => 'XXXXX', CLEANUP => 1) or die "Unable to create temporary file directory.";
system("$mapping_bin --bam bam1=$mapping_dir/input/sample1.bam --bam bam2=$mapping_dir/input/sample2.bam --bam bam3=$mapping_dir/input/sample3.bam --bam bam4=$mapping_dir/input/sample4.bam 2>&1");
...
$create_dir = tempdir(TEMPLATE => 'XXXXX', CLEANUP => 1) or die "Unable to create temporary file directory.";
system("$mapping_bin -l ".$create_dir."/ --bam bam1=$mapping_dir/input/draft_reference/sample1.bam 2>&1");
ok(-e $create_dir."/mapping_percentage.log", "Script runs when draft genomes are used.");

#9 => verify that the script return the appropriate number of samples for the draft genome
$create_dir = tempdir(TEMPLATE => 'XXXXX', CLEANUP => 1) or die "Unable to create temporary file directory.";
system("$mapping_bin -l ".$create_dir."/ --bam bam1=$mapping_dir/input/draft_reference/sample1.bam --min-map 99.9 2>&1");
ok(countLines($create_dir."/mapping_percentage.log") == 5, "The correct output is generated when the reads map to multiple draft reference contigs.");
