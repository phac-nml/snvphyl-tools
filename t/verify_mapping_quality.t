...
ok(countLines("$mapping_dir/output/3/mapping_percentage.log") == 3, "The correct number of isolates are logged when min_depth altered.");
...
$command = "$mapping_bin -l $mapping_dir/output/6/ -i $mapping_dir/input/ --bam bam1=$mapping_dir/input/sample1.bam --bam bam2=$mapping_dir/input/sample2.bam --bam bam3=$mapping_dir/input/sample3.bam --bam bam4=$mapping_dir/input/sample4.bam -c 2";
...
system("$mapping_bin -i $mapping_dir/input/ --bam bam1=$mapping_dir/input/sample1.bam --bam bam2=$mapping_dir/input/sample2.bam --bam bam3=$mapping_dir/input/sample3.bam --bam bam4=$mapping_dir/input/sample4.bam");
