...
system("$rearrange_bin -k -r VC-18 -s increasing -t $script_dir/tree/input/snv_align.phy_phyml_tree.txt -o ".$create_dir."/ -m $script_dir/tree/input/matrix.csv -p $script_dir/tree/input/snv_align.phy 2>&1");
...
system("$rearrange_bin -t $script_dir/tree/input/snv_align.phy_phyml_tree.txt -o ".$create_dir."/ -m $script_dir/tree/input/matrix.csv -p $script_dir/tree/input/snv_align.phy 2>&1");
...
$create_dir = tempdir(TEMPLATE => 'XXXXX', CLEANUP => 1) or die "Unable to create temporary file directory.";
system("$rearrange_bin -s increasing -t $script_dir/tree/input/snv_align.phy_phyml_tree.txt -o ".$create_dir."/ -m $script_dir/tree/input/matrix.csv -p $script_dir/tree/input/snv_align.phy 2>&1");
...
$create_dir = tempdir(TEMPLATE => 'XXXXX', CLEANUP => 1) or die "Unable to create temporary file directory.";
system("$rearrange_bin -s decreasing -t $script_dir/tree/input/snv_align.phy_phyml_tree.txt -o ".$create_dir."/ -m $script_dir/tree/input/matrix.csv -p $script_dir/tree/input/snv_align.phy 2>&1");
...
$create_dir = tempdir(TEMPLATE => 'XXXXX', CLEANUP => 1) or die "Unable to create temporary file directory.";
system("$rearrange_bin -k -c -r VC-10 -s increasing -t $script_dir/tree/input/snv_align.phy_phyml_tree.txt -o ".$create_dir."/ -m $script_dir/tree/input/matrix.csv -p $script_dir/tree/input/snv_align.phy 2>&1");
...
$create_dir = tempdir(TEMPLATE => 'XXXXX', CLEANUP => 1) or die "Unable to create temporary file directory.";
$command = "$rearrange_bin -r VC-18 -s increasing -t $script_dir/tree/input/INVALIDsnv_align.phy_phyml_tree.txt -o ".$create_dir."/ -m $script_dir/tree/input/matrix.csv -p $script_dir/tree/input/snv_align.phy 2>/dev/null";
...
$create_dir = tempdir(TEMPLATE => 'XXXXX', CLEANUP => 1) or die "Unable to create temporary file directory.";
$command = "$rearrange_bin -r VC-18 -s increasing -t $script_dir/tree/input/snv_align.phy_phyml_tree.txt -o ".$create_dir."/ -m $script_dir/tree/input/INVALIDmatrix.csv -p $script_dir/tree/input/snv_align.phy 2>/dev/null";
ok(system(`$command`)!=0, "Invalid newick files are not accepted.");

#9 => verify that the script dies properly when an invalid snv_align.phy file is input
$create_dir = tempdir(TEMPLATE => 'XXXXX', CLEANUP => 1) or die "Unable to create temporary file directory.";
$command = "$rearrange_bin -r VC-18 -s increasing -t $script_dir/tree/input/snv_align.phy_phyml_tree.txt -o ".$create_dir."/ -m $script_dir/tree/input/matrix.csv -p $script_dir/tree/input/INVALIDsnv_align.phy 2>/dev/null";
ok(system(`$command`)!=0, "Invalid snv_align.phy files are not accepted.");
