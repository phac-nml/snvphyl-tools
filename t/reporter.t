...
my $results = $reporter->record_read_mapping_data(to_json(\%test_json), 'reporter/sample1.bam', 'reporter/sample2.bam', 'reporter/sample3.bam');
is_valid_json($results);
...
my $ref_stats = $reporter->record_reference_info($filter_stats, '../t/reporter/reference.fasta', 'Illumina', 'NCBI', 'YES');
print $ref_stats;
