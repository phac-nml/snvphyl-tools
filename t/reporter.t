...
$output = `perl $script_dir/../reporter.pl --step=record_filter_stats --output=$create_dir/reporter.json --snvalign=t/reporter/snv_align-positions1.tsv --json=$create_dir/reporter.json`;
